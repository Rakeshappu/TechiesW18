...
def background_process_new():
    ...
    cdfule=cdsmallcar+cdmediumcar+cdlargecar+cdbike
    global new_input 
    predc=pred(cdpng,cdlpg,cdcng,cdelectricity,cdfule,cdwaste)
    print(predc)
...
def pred():
    ...
    if request.method == 'POST':
        ...
        # return prediction
        return render_template('pledge.html',result=prediction)
